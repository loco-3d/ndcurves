...
typedef exact_cubic<Numeric, Numeric, false, point_one_dim_t>
...
class rotation_spline : public curve_abc_quat_t {
 public:
   ...
   */
  bool isApprox(
      const rotation_spline& other,
      const Numeric prec = Eigen::NumTraits<Numeric>::dummy_precision()) const {
    return ndcurves::isApprox<Numeric>(min_, other.min_) &&
           ndcurves::isApprox<Numeric>(max_, other.max_) &&
  ...
  virtual bool isApprox(
      ...
      const Numeric prec = Eigen::NumTraits<Numeric>::dummy_precision()) const {
    const rotation_spline* other_cast =
        dynamic_cast<const rotation_spline*>(other);
    if (other_cast)
...
typedef exact_cubic<Time, Numeric, false, quat_t,
...
class effector_spline_rotation {
 ...
 public:
  ...
  /// pointing to the last element of a waypoint container. \param to_quat : 4D
  ...
  /// normals. \param wayPointsBegin       : an iterator pointing to the first
  /// element of a waypoint container. \param wayPointsEnd         : an iterator
  /// pointing to the last element of a waypoint container. \param
  ...
  /// \param quatWayPointsEnd     : en iterator pointing to the last element of
  ...
  ///  \return A 7D vector where the 3 first values are the 3D position and the
  ///  4 last are the quaternion describing the rotation.
  ///
